...
\author{Aaron Kampmeier \\ \texttt{akampmei@asu.edu} \And Brandon Evans \\ \texttt{bpevans@asu.edu} \And Braeden Woodward \\ \texttt{bmwoodar@asu.edu} \And Pavan Kumar Raja \\ \texttt{praja3@asu.edu}}
...
% \cite{ZuoMax2022EEvF}
% \cite{9164659}
% \cite{LaValleStevenM.2001RKP}
% \cite{Perez-HiguerasNoe2018TRNB}
...
Rapidly-Exploring Random Trees (RRT) \cite{LaValleStevenM.2001RKP} have proven to be a very useful 
...
% TODO Fill out related work summaries
...
For our problem the agebt is creating a path to navigate from start to goal. In order to do this, our agent uses an RRT algorithm.
